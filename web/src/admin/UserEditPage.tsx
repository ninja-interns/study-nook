						...
						<div className={classes.main}>
							<form className={classes.form} noValidate onSubmit={handleSubmit}>
								<Grid container spacing={2}>
									...
									<Grid item xs={12}>
										<TextField variant="outlined" required fullWidth id="id" name="id" autoComplete="id" placeholder={user?.id} contentEditable="false" />
									</Grid>
									<Grid item xs={12}>
										<FormLabel>Token</FormLabel>
									</Grid>
									<Grid item xs={12}>
										<TextField variant="outlined" required fullWidth id="id" name="id" autoComplete="id" placeholder={user?.token} contentEditable="false" />
									</Grid>
									<Grid item xs={12}>
